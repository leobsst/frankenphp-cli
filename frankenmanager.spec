...
resource_files = [
    ...
    ("caddy/sites/default/localhost_Caddyfile", "resources/caddy/sites/default"),
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "frankenmanager.commands.switch_php",
        "frankenmanager.commands.list_hosts",
        "frankenmanager.core",
        "frankenmanager.core.config",
        "frankenmanager.core.php_versions",
